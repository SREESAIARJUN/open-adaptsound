...
**Download:** [Latest Windows installer (`.exe`)](https://github.com/SREESAIARJUN/open-adaptsound/releases/latest) · **Requires:** [Equalizer APO](https://sourceforge.net/projects/equalizerapo/files/latest/download)
